...
$(function () {
  ...
  function refresh(ranges) {
    ...
    $.getJSON("/gettops", data2, function(data) {
      data2.tops = data;
      $.getJSON("/costperday", data2, function(data) {
        plot = $.plot($("#placeholder"), data, plot_options);
      });
      $.getJSON("/costpermonth", {tops:data}, function(data) {
...
function refresh_analysis_table() {
  ...
  */
  ...
  $.getJSON("/getcalls", {min:analysis_min,max:analysis_max}, function(data) {
